...
export const TemplateCardSelection = ({templateName, setTemplateSelected}: props) => {
  ...
  return (
    <button
      ...
      type="button"
      class="select-none relative h-72 min-w-fit aspect-[9/16] flex items-end rounded-lg shadow-md shadow-remaxBlue-200/30 overflow-hidden border-remaxWhite-200 border-2 snap-center focus:border-remaxRed-100/50 focus:shadow-remaxRed-100/50"
    >
